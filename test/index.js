...
var AnsibleCli = require('../lib/index.js');
...
describe('AnsibleCli run without modifications', function () {

  it('should merge opts', function () {
    var ansibleCli = new AnsibleCli({ a: 'a' });
...
//    var failed = false;
//    var err = null;
//    ansibleCli.command('iam2 list-users').then(function (data) {
