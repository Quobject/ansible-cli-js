...
var AnsibleCli = function (opts) {
  if (!(this instanceof AnsibleCli)) {
    return new AnsibleCli(opts);
  }

  _.merge(this, opts); 
};

AnsibleCli.prototype.command = function (command, options, callback) {
  var self = this;
